 ...
 *
 * Return: return if tree is NULL, your function must return 0.
 */
 ...
 *
 * Return: return if tree is NULL, must return 0.
 */
 ...
 *
 * Return: return if tree is NULL, function must return 0.
 */
